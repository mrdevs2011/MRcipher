...
export function KeyIcon({ size = 24 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden>
      <path d="M21 2l-2 2m-7.61 7.61a5.5 5.5 0 0 1-7.78 7.78 5.5 5.5 0 0 1 7.78-7.78" />
      <path d="M15 15l-3.5-3.5" />
      <path d="M17.5 6.5L22 11" />
    </svg>
  );
}

export function ExclamationIcon({ size = 20 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden>
...
export function FlaskIcon({ size = 20 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden>
      <path d="M10 2v7.31" />
      <path d="M14 2v7.31" />
      <path d="M8.5 2h7" />
      <path d="M14 9.3a6.5 6.5 0 0 1-10.62 7.06 6.7 6.7 0 0 1-.79-1.29l-1.56-3.39A1.5 1.5 0 0 1 2.39 10l4.83-1.56" />
      <path d="M16 9.3a6.5 6.5 0 0 0 10.62 7.06 6.7 6.7 0 0 0 .79-1.29l1.56-3.39A1.5 1.5 0 0 0 21.61 10l-4.83-1.56" />
    </svg>
  );
}

export function DocIcon({ size = 20 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden>
