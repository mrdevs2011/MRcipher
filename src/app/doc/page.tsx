 ...
 * API kalitlar, Endpointlar, Fayl tekshirish) vizual jihatdan farqlanardi:
 * boshqa logotip, "Bosh sahifa" tugmasi, foydalanuvchi profili yo'q sidebar va h.k.
 *
      ...
      <div className="app-shell">
        ...
        <main className="app-main">
          <div className="container doc-page">
            ...
            <h2 id="kalit">2. API key qoidalari</h2>
            <div className="card">
              <ul>
            ...
            <h2 id="shifrlash">3. Ma&rsquo;lumotni shifrlash</h2>
            <p>
...
print(res.json()["data"])`}</pre>
            ...
            <h2 id="ochish">4. Shifrlangan ma&rsquo;lumotni ochish</h2>
            <p>
...
const data = mrcipher.decryptDoc(doc.data());`}</pre>
            ...
            <h2 id="xavfsizlik">6. Xavfsizlik tez faktlar</h2>
            <div className="card">
              <ul>
                <li>
            ...
            <h2 id="test">7. Qo&rsquo;lda sinash</h2>
            <p>
            ...
            <h2 id="endpointlar">8. Endpointlar jadvali</h2>
